//
// Created by https://github.com/friedmud/variadic_table
//

#ifndef CACHECPP_LIB_VARIADICTABLE_H_
#define CACHECPP_LIB_VARIADICTABLE_H_
...
#endif //CACHECPP_LIB_VARIADICTABLE_H_
